...
Pattern 4 (Both Connections): Sup=1, Sub=1
    ...
    def create_summary_heatmap (self ):
        ...
        exclude_metrics =["CDC Score","adj-CDC Score"]
...
def main ():
    ...
    OUTPUT_PLOTS =os .path .join (conf .ANALYSIS_DIR ,"09_Interaction_Plots")
    OUTPUT_SUMMARY =os .path .join (conf .ANALYSIS_DIR ,"10_Analysis_Summary_国際論文用")# Folder/File: 10_Analysis_Summary_For_International_Paper | Folder/File: 10_Analysis_Summary_For_International_Paper | Folder/File: 10_Analysis_Summary_国際論文用
